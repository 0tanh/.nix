...
{
  /**
    This is ported from Version33's flake:
    Source :https://github.com/Version33/dotfiles/blob/main/modules/wrapped/niri.nix
  */
  perSystem =
    {
      pkgs,
    ...
    let
      ...
      xwayland-satellite-patched = pkgs.xwayland-satellite.overrideAttrs (old: {
        patches = (old.patches or [ ]) ++ [ ../../../../assets/xwayland-satellite-popup-exact.patch ];
      });
